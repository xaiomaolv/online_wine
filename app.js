...
App({
  ...
  globalData: {
    // api/files/sc/find-by-uuid?uuid=
    capsule: '',
    isLogin: false, // 是否授权登录
    isFirst: false, // 是否第一次使用
    // 图片访问地址
    // imgUrl: 'http://dev.vivino.cc/app-api/appapi/api/files/sc/find-by-uuid?uuid=',
    imgUrl: 'https://api.vivino.cc/app-api/appapi/api/files/sc/find-by-uuid?uuid=',
    // 扫酒
    // scanWine:'http://dev.vivino.cc/app-api/appapi/miniProgram/api/appletScan',
    scanWine:'https://api.vivino.cc/app-api/appapi/miniProgram/api/appletScan',
    // 扫酒教学视频
